...
export type GenreIconName = (typeof genreIconNames)[number];

const genreIconNameSet: ReadonlySet<string> = new Set(genreIconNames);
...
export function isGenreIconName(value: string): value is GenreIconName {
  return genreIconNameSet.has(value);
}
