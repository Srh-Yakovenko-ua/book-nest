 ...
 * @nullable
 */
export type CharacterGraphViewDtoEdgesItemType =
  | (typeof CharacterGraphViewDtoEdgesItemType)[keyof typeof CharacterGraphViewDtoEdgesItemType]
  | null;

export const CharacterGraphViewDtoEdgesItemType = {
