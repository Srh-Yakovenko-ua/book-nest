 ...
 */
import type { BulkPagesCountResultDtoFailedItem } from "./bulkPagesCountResultDtoFailedItem";

export interface BulkPagesCountResultDto {
  failed: BulkPagesCountResultDtoFailedItem[];
