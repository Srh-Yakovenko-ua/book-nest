 ...
 */
import type { BulkReadingStatusInputDtoReadingStatus } from "./bulkReadingStatusInputDtoReadingStatus";

export interface BulkReadingStatusInputDto {
  /**
   * @minItems 1
   * @maxItems 100
   ...
   */
  bookIds: string[];
  readingStatus: BulkReadingStatusInputDtoReadingStatus;
}
