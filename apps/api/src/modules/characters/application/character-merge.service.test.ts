...
function createService(
  ...
  const mergeRepository = {
    ...
    deleteForms: vi.fn().mockResolvedValue(undefined),
    ...
    findLoserForms: vi.fn().mockResolvedValue([]),
    ...
    findSurvivorFormKeys: vi.fn().mockResolvedValue([]),
    ...
    repointForms: vi.fn().mockResolvedValue(undefined),
